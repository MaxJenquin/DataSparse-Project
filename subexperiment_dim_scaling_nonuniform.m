%% Auxiliary Numerical Experiment: fixed dataset scale, nonuniform grid, 
% dimensionality scaling, no CG iteration

% This sub-experiment mirrors experiment_dim_scaling_nonuniform.m, but with
% no CG iteration to slow it down and prevent it from reaching
% high-dimensional results. Its counterpart in the uniform case is
% likewise the mirror of experiment_dim_scaling_uniform.m, and can be
% found in subexperiment_dim_scaling_uniform.m
...
save('data/dim_scaling_nonuniform_extra.mat','default_times','rskelf_times',...
    'hodlr_times','problem_sizes');
